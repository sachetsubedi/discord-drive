...
export default function FilesPage() {
  ...
  const performAutoCrawl = async () => {
    try {
      ...
      const crawlResponse = await axiosInstance.post(
        "/api/discord-bot",
        {
          action: "crawl",
        },
      ...
      if (crawlResponse.data.totalAttachments > 0) {
        setCrawlStatus(
          `Found ${crawlResponse.data.totalAttachments} new files`
        );
  ...
  const downloadFile = async (file: StoredFile) => {
    try {
      ...
      const downloadUrl = `/api/download?fileId=${encodeURIComponent(
        file.id
      ...
      try {
        const fallbackUrl = `/api/download?url=${encodeURIComponent(
          file.discordUrl
        )}&filename=${encodeURIComponent(file.originalName)}`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <p className="text-gray-600">
                ...
                {filteredAndSortedFiles.length !== 1 ? "s" : ""} found
              </p>
        ...
        <Dialog open={viewDialogOpen} onOpenChange={setViewDialogOpen}>
          <DialogContent className="w-fit overflow-auto !max-w-full">
            <DialogHeader>
        ...
        <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to delete this file? The file will be
                hidden from your gallery and won&apos;t be re-added during
                future crawls.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
